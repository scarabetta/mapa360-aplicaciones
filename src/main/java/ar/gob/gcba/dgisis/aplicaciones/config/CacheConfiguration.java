...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("mapa360aplicaciones");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("mapa360aplicaciones");
        ...
        config.getMapConfigs().put("ar.gob.gcba.dgisis.aplicaciones.domain.*", initializeDomainMapConfig(jHipsterProperties));
